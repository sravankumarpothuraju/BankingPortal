...
const temp_app = fs.readFileSync(path.join(process.cwd(), 'src/router.js'), 'utf8');
const overwritten = temp_app.replace(/app\.listen\([\s\S]*\);?/g, 'router.listen(3000);')
