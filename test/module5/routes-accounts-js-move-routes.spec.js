...
describe('Move account routes', () => {
  it('`accounts.js` should contain routes @routes-accounts-js-move-routes', () => {
    ...
    assert(routeStack('/savings', 'get') === undefined, 'The savings route has not been removed from `router.js`.');
    assert(routeStack('/checking', 'get') === undefined, 'The checking route has not been removed from `router.js`.');
    assert(routeStack('/credit', 'get') === undefined, 'The credit route has not been removed from `router.js`.');
