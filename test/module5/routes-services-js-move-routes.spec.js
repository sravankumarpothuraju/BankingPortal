...
describe('Move services routes', () => {
  it('`services.js` should contain routes @routes-services-js-move-routes', () => {
    ...
    assert(routeStack('/transfer', 'get') === undefined, 'The transfer get route has not been removed from `router.js`.');
    assert(routeStack('/transfer', 'post') === undefined, 'The transfer post route has not been removed from `router.js`.');
    assert(routeStack('/payment', 'get') === undefined, 'The payment get route has not been removed from `router.js`.');
    assert(routeStack('/payment', 'post') === undefined, 'The payment post route has not been removed from `router.js`.');
